"""
DM pairing and authentication for the Atlas Gateway.
...
logger = logging.getLogger("atlas.gateway.pairing")
...
class PairingManager:
    """
    Manages DM pairing and authentication for the Atlas Gateway.
    ...
    def __init__(
        ...
        self._secret = secret or os.environ.get("ATLAS_PAIRING_SECRET", secrets.token_hex(32))
