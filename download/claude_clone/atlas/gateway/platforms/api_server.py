"""
REST API server adapter for the Atlas Gateway.
...
logger = logging.getLogger("atlas.gateway.platforms.api_server")
...
class APIServerAdapter:
    ...
    def _create_app(self) -> "FastAPI":
        ...
        app = FastAPI(
            title="Atlas Gateway API",
            description="REST API for the Atlas multi-platform messaging gateway",
            version="1.0.0",
        )
