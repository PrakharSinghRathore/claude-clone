"""
Dynamic System Prompt Builder for Atlas Agent.
...
-----
    ...
    builder.set_section(PromptSection.IDENTITY, "You are Atlas...")
...
class PromptBuilder:
    ...
    ----------
    agent_name:
        The display name of the agent (default: "Atlas Agent").
    context_dict:
