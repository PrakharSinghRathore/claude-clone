...
from atlas.constants import ATLAS_DATA_HOME, TRAJECTORY_DIR
...
class TrajectoryRecorder:
    ...
    output_dir:
        ...
        the default Atlas trajectory directory.
    model_name:
    ...
    def __init__(
        ...
        self._output_dir = Path(output_dir) if output_dir else ATLAS_DATA_HOME / TRAJECTORY_DIR
