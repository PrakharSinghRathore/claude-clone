"""
Atlas File Tools — enhanced file system operations.
...
async def atlas_file_read(path: str, offset: int = 0, limit: int = 0) -> str:
...
async def atlas_file_write(path: str, content: str) -> str:
...
async def atlas_file_edit(path: str, old_str: str, new_str: str) -> str:
...
async def atlas_file_append(path: str, content: str) -> str:
...
async def atlas_file_delete(path: str) -> str:
    """Delete a file.
...
async def atlas_file_move(src: str, dst: str) -> str:
...
async def atlas_file_copy(src: str, dst: str) -> str:
...
async def atlas_file_list(path: str = ".", show_hidden: bool = False) -> str:
...
async def atlas_file_search(pattern: str, directory: str = ".") -> str:
...
async def atlas_file_metadata(path: str) -> str:
...
async def atlas_file_batch_delete(paths: str) -> str:
...
async def atlas_mkdir(path: str) -> str:
...
ToolRegistry.instance().register(
    ...
    func=atlas_file_write,
    description="Write content to a file, creating parent directories as needed.",
    toolset="file",
)

ToolRegistry.instance().register(
    name="atlas_file_edit",
    func=atlas_file_edit,
    description="Find and replace exact text within a file.",
    toolset="file",
)

ToolRegistry.instance().register(
    name="atlas_file_append",
    func=atlas_file_append,
    description="Append content to the end of a file.",
    toolset="file",
)

ToolRegistry.instance().register(
    name="atlas_file_delete",
    func=atlas_file_delete,
    description="Delete a file.",
    toolset="file",
)

ToolRegistry.instance().register(
    name="atlas_file_move",
    func=atlas_file_move,
    description="Move or rename a file or directory.",
    toolset="file",
)

ToolRegistry.instance().register(
    name="atlas_file_copy",
    func=atlas_file_copy,
    description="Copy a file or directory.",
    toolset="file",
)

ToolRegistry.instance().register(
    name="atlas_file_list",
    func=atlas_file_list,
    description="List directory contents.",
    toolset="file",
)

ToolRegistry.instance().register(
    name="atlas_file_search",
    func=atlas_file_search,
    description="Search for files matching a glob pattern.",
    toolset="file",
)

ToolRegistry.instance().register(
    name="atlas_file_metadata",
    func=atlas_file_metadata,
    description="Get detailed metadata for a file or directory.",
    toolset="file",
)

ToolRegistry.instance().register(
    name="atlas_file_batch_delete",
    func=atlas_file_batch_delete,
