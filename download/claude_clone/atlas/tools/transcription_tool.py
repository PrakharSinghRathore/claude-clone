"""
Atlas Transcription Tool — speech-to-text audio transcription.
...
async def atlas_transcribe_with_timestamps(
    audio_path: str,
    language: str = "",
...
async def atlas_detect_language(audio_path: str) -> str:
...
ToolRegistry.instance().register(
    ...
    func=atlas_transcribe,
    description="Transcribe an audio file to text using speech recognition.",
    toolset="audio",
)

ToolRegistry.instance().register(
    name="atlas_transcribe_with_timestamps",
    func=atlas_transcribe_with_timestamps,
    description="Transcribe audio with per-segment timestamps.",
    toolset="audio",
)

ToolRegistry.instance().register(
    name="atlas_detect_language",
    func=atlas_detect_language,
