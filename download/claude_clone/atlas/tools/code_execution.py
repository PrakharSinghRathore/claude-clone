"""
Atlas Code Execution — sandboxed code execution in multiple languages.
...
async def atlas_exec_javascript(
    code: str,
    timeout: int = 30,
) -> str:
...
ToolRegistry.instance().register(
    name="atlas_exec_python",
    func=atlas_exec_python,
    description="Execute Python code in a sandboxed environment with optional auto-install.",
    toolset="execution",
)

ToolRegistry.instance().register(
    name="atlas_exec_javascript",
    func=atlas_exec_javascript,
    description="Execute JavaScript code using Node.js.",
    toolset="execution",
)

ToolRegistry.instance().register(
    name="atlas_exec_bash",
    func=atlas_exec_bash,
