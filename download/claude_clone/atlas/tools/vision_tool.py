"""
Atlas Vision Tool — image understanding and analysis.
...
async def atlas_image_caption(image_path: str) -> str:
...
ToolRegistry.instance().register(
    name="atlas_analyze_image",
    func=atlas_analyze_image,
...
ToolRegistry.instance().register(
    name="atlas_image_caption",
    func=atlas_image_caption,
