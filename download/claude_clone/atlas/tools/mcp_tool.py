"""
Atlas MCP Tool — Model Context Protocol integration for tool discovery.
...
async def atlas_mcp_discover() -> str:
...
async def atlas_mcp_list_tools(server_name: str = "") -> str:
...
async def atlas_mcp_connect(server_name: str) -> str:
...
ToolRegistry.instance().register(
    name="atlas_mcp_discover",
    func=atlas_mcp_discover,
    description="Discover configured MCP servers from config files.",
    toolset="mcp",
)

ToolRegistry.instance().register(
    name="atlas_mcp_list_tools",
    func=atlas_mcp_list_tools,
    description="List tools available from MCP servers.",
    toolset="mcp",
)

ToolRegistry.instance().register(
    name="atlas_mcp_connect",
    func=atlas_mcp_connect,
    description="Connect to an MCP server and load its tools.",
    toolset="mcp",
)

ToolRegistry.instance().register(
    name="atlas_mcp_resources",
    func=atlas_mcp_resources,
    description="List available MCP resources from connected servers.",
    toolset="mcp",
)

ToolRegistry.instance().register(
    name="atlas_mcp_prompt",
    func=atlas_mcp_prompt,
