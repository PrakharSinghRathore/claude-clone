"""
Atlas Todo Tool — task management with priorities, due dates, and subtasks.
...
_TODO_DB_PATH = Path.home() / ".claude_clone" / "atlas_todos.json"
...
async def atlas_todo_delete(todo_id: str) -> str:
    """Delete a todo item.
...
async def atlas_todo_list(list_name: str = "", status: str = "", show_all: bool = False) -> str:
...
async def atlas_todo_add_subtask(todo_id: str, title: str) -> str:
...
async def atlas_todo_complete_subtask(todo_id: str, subtask_id: str) -> str:
...
ToolRegistry.instance().register(
    name="atlas_todo_create",
    func=atlas_todo_create,
    description="Create a new todo item with priority, due date, and tags.",
    toolset="productivity",
)

ToolRegistry.instance().register(
    name="atlas_todo_update",
    func=atlas_todo_update,
    description="Update an existing todo (status, progress, priority, title).",
    toolset="productivity",
)

ToolRegistry.instance().register(
    name="atlas_todo_delete",
    func=atlas_todo_delete,
    description="Delete a todo item by ID.",
    toolset="productivity",
)

ToolRegistry.instance().register(
    name="atlas_todo_list",
    func=atlas_todo_list,
    description="List todo items with optional filtering by list, status, and priority.",
    toolset="productivity",
)

ToolRegistry.instance().register(
    name="atlas_todo_add_subtask",
    func=atlas_todo_add_subtask,
    description="Add a subtask to a todo item.",
    toolset="productivity",
)

ToolRegistry.instance().register(
    name="atlas_todo_complete_subtask",
    func=atlas_todo_complete_subtask,
