"""
Gateway management commands for Atlas CLI.
...
GATEWAY_STATE_FILE = Path.home() / ".claude_clone" / "atlas" / "gateway_state.json"
...
class GatewayManager:
    """Manages the Atlas multi-platform gateway."""
    ...
    def get_logs(self, limit: int = 100) -> List[str]:
        ...
        log_file = Path.home() / ".claude_clone" / "atlas" / "gateway.log"
