"""
Interactive setup wizard for Atlas CLI first-run configuration.
...
class SetupWizard:
    ...
    def run(self, skip_api: bool = False) -> Dict[str, Any]:
        ...
        self._print_fn("  You can start using Atlas CLI now.")
