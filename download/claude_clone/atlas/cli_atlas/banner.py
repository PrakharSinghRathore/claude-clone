"""
Startup banner, branding, and system info display for Atlas CLI.
"""
...
from atlas.cli_atlas.skin_engine import SkinEngine, rgb_color, RESET, BOLD, DIM
...
class Banner:
    ...
    def show_mini(self) -> str:
        ...
        return ATLAS_MINI.format(version=__version__).strip()
    ...
    def show_welcome(self, username: Optional[str] = None) -> str:
        ...
        return f"\n  {rgb_color(r, g, b)}{greeting}, {name}! Welcome to Atlas CLI.{RESET}"
