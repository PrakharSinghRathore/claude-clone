"""
Skin/Theme engine for Atlas CLI.
...
THEMES_DIR = Path.home() / ".claude_clone" / "atlas" / "themes"
...
class SkinEngine:
    """Manages visual themes and skins for the Atlas CLI."""
    ...
    def get_prompt_style(self, style_name: Optional[str] = None) -> Dict:
        ...
        style_key = style_name or self.get_theme().get("prompt", {}).get("style", "atlas")
        return PROMPT_STYLES.get(style_key, PROMPT_STYLES["atlas"])
