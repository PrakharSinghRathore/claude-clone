"""
Skills Hub — Marketplace browser for Atlas CLI skills.
...
from atlas.cli_atlas.config_manager import SKILLS_DIR, ConfigManager
from atlas.cli_atlas.skills_config import SKILL_CATEGORIES
