"""
Hermes Image Generation Tool — AI-powered image generation.
...
async def hermes_generate_image(
    prompt: str,
    size: str = "1024x1024",
    output_path: str = "",
    style: str = "",
...
async def hermes_image_gallery(limit: int = 20) -> str:
    ...
    if not images:
        return "Gallery is empty. Use hermes_generate_image to create images."
...
async def hermes_image_info(image_path: str) -> str:
...
async def hermes_image_delete(image_path: str) -> str:
...
ToolRegistry.instance().register(
    name="hermes_generate_image",
    func=hermes_generate_image,
    description="Generate an AI image from a text prompt with size and style control.",
    toolset="media",
)

ToolRegistry.instance().register(
    name="hermes_image_gallery",
    func=hermes_image_gallery,
    description="List generated images in the gallery.",
    toolset="media",
)

ToolRegistry.instance().register(
    name="hermes_image_info",
    func=hermes_image_info,
    description="Get detailed information about an image file.",
    toolset="media",
)

ToolRegistry.instance().register(
    name="hermes_image_delete",
    func=hermes_image_delete,
