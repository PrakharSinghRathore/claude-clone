"""
Hermes Skill Manager — advanced skill lifecycle management.
...
async def hermes_skill_from_conversation(
    name: str,
...
async def hermes_skill_version(name: str, version: str = "", message: str = "") -> str:
...
async def hermes_skill_versions(name: str) -> str:
...
async def hermes_skill_add_dependency(name: str, dependency: str) -> str:
...
async def hermes_skill_test(name: str, test_input: str = "") -> str:
...
ToolRegistry.instance().register(
    name="hermes_skill_from_conversation",
    func=hermes_skill_from_conversation,
    description="Create a new skill from a recurring conversation pattern.",
    toolset="skills",
)

ToolRegistry.instance().register(
    name="hermes_skill_version",
    func=hermes_skill_version,
    description="Create a version snapshot of a skill.",
    toolset="skills",
)

ToolRegistry.instance().register(
    name="hermes_skill_versions",
    func=hermes_skill_versions,
    description="List all saved versions of a skill.",
    toolset="skills",
)

ToolRegistry.instance().register(
    name="hermes_skill_add_dependency",
    func=hermes_skill_add_dependency,
    description="Add a dependency requirement to a skill.",
    toolset="skills",
)

ToolRegistry.instance().register(
    name="hermes_skill_test",
    func=hermes_skill_test,
