"""
Hermes Browser Tool — headless browser automation via httpx + HTML parsing.
...
async def hermes_browser_navigate(url: str) -> str:
...
async def hermes_browser_get_links(url: str) -> str:
...
async def hermes_browser_get_forms(url: str) -> str:
...
async def hermes_browser_submit_form(
    url: str,
    form_index: int = 0,
    field_values: str = "{}",
) -> str:
...
async def hermes_browser_screenshot(url: str, output_path: str = "") -> str:
...
async def hermes_browser_cookies(domain: str = "") -> str:
...
ToolRegistry.instance().register(
    ...
    func=hermes_browser_navigate,
    description="Navigate to a URL and return page content summary with links and forms.",
    toolset="browser",
)

ToolRegistry.instance().register(
    name="hermes_browser_get_links",
    func=hermes_browser_get_links,
    description="Extract all hyperlinks from a web page.",
    toolset="browser",
)

ToolRegistry.instance().register(
    name="hermes_browser_get_forms",
    func=hermes_browser_get_forms,
    description="Extract all forms and their input fields from a web page.",
    toolset="browser",
)

ToolRegistry.instance().register(
    name="hermes_browser_submit_form",
    func=hermes_browser_submit_form,
...
ToolRegistry.instance().register(
    ...
    func=hermes_browser_screenshot,
    description="Capture a screenshot of a web page (requires wkhtmltoimage).",
    toolset="browser",
)

ToolRegistry.instance().register(
    name="hermes_browser_cookies",
    func=hermes_browser_cookies,
