"""
Hermes Memory Tool — persistent memory operations with tags and importance.
...
_DB_PATH = Path.home() / ".claude_clone" / "hermes_memory.db"
...
async def hermes_memory_retrieve(memory_id: str = "", query: str = "", limit: int = 5) -> str:
...
async def hermes_memory_delete(memory_id: str = "", category: str = "") -> str:
...
async def hermes_memory_search(query: str, limit: int = 10) -> str:
    """Full-text search across all memories.

    param query (str): — Search query.
    param limit (int): — Max results. Default: 10.
    """
    return await hermes_memory_retrieve(query=query, limit=limit)


async def hermes_memory_list(
    category: str = "",
    tag: str = "",
...
async def hermes_memory_stats() -> str:
...
ToolRegistry.instance().register(
    ...
    func=hermes_memory_store,
    description="Store a new memory with tags, importance score, and category.",
    toolset="memory",
)

ToolRegistry.instance().register(
    name="hermes_memory_retrieve",
    func=hermes_memory_retrieve,
