"""
GatewayRunner — Main orchestrator for the Hermes Gateway.
...
from hermes.gateway.mirror import MessageMirror
...
logger = logging.getLogger("hermes.gateway.runner")
...
class GatewayRunner:
    """
    Main orchestrator for the Hermes Gateway.
    ...
    PLATFORM_ADAPTERS: Dict[str, str] = {
        "telegram": "hermes.gateway.platforms.telegram.TelegramAdapter",
        "discord": "hermes.gateway.platforms.discord.DiscordAdapter",
        "slack": "hermes.gateway.platforms.slack.SlackAdapter",
        "whatsapp": "hermes.gateway.platforms.whatsapp.WhatsAppAdapter",
        "signal": "hermes.gateway.platforms.signal.SignalAdapter",
        "matrix": "hermes.gateway.platforms.matrix.MatrixAdapter",
        "email": "hermes.gateway.platforms.email_platform.EmailAdapter",
        "sms": "hermes.gateway.platforms.sms.SMSAdapter",
        "webhook": "hermes.gateway.platforms.webhook.WebhookAdapter",
        "api": "hermes.gateway.platforms.api_server.APIServerAdapter",
        "dingtalk": "hermes.gateway.platforms.dingtalk.DingTalkAdapter",
        "feishu": "hermes.gateway.platforms.feishu.FeishuAdapter",
        "wecom": "hermes.gateway.platforms.wecom.WeComAdapter",
        "mattermost": "hermes.gateway.platforms.mattermost.MattermostAdapter",
    }
    ...
    async def start(self) -> None:
        ...
        self._running = True
        logger.info(
            "Hermes Gateway started with %d platform(s)",
            len(self._adapters),
        )
    ...
    async def stop(self) -> None:
        ...
        """
        logger.info("Hermes Gateway stopping...")
        self._running = False
