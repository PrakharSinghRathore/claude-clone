"""
Shared constants for the Hermes Agent system.

Defines paths, version information, default configurations, and module-wide
constants used across all Hermes core components.
"""
...
HERMES_NAME: str = "Hermes Agent Core"
HERMES_MODULE_NAME: str = "hermes"

# ──────────────────────────────────────────────────────────────────────────────
# Paths
# ──────────────────────────────────────────────────────────────────────────────

# Base directory for all Hermes data (respects XDG_DATA_HOME)
HERMES_DATA_HOME: Path = Path(
    os.environ.get("HERMES_DATA_HOME", "")
    or os.environ.get("XDG_DATA_HOME", "")
    or (Path.home() / ".local" / "share")
) / "hermes"

# Configuration directory (respects XDG_CONFIG_HOME)
HERMES_CONFIG_HOME: Path = Path(
    os.environ.get("HERMES_CONFIG_HOME", "")
    or os.environ.get("XDG_CONFIG_HOME", "")
    or (Path.home() / ".config")
) / "hermes"

# Cache directory (respects XDG_CACHE_HOME)
HERMES_CACHE_HOME: Path = Path(
    os.environ.get("HERMES_CACHE_HOME", "")
