...
with the existing ``agent/model_router.py`` while providing Hermes-specific
enhancements.
...
from hermes.constants import ROUTING_COST_WEIGHT, ROUTING_LATENCY_WEIGHT, ROUTING_QUALITY_WEIGHT
from hermes.core.model_metadata import ModelCapability, ModelInfo, ModelMetadata, get_model_info
