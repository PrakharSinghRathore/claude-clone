...
PRICING_DB: Dict[str, Tuple[float, float]] = {
    ...
    "hermes-3-llama-3.1-405b": (2.7, 2.7),
    "hermes-3-llama-3.1-70b": (0.39, 0.39),
}
...
class UsagePricing:
    ...
    def __init__(
        ...
        self._persistence_dir = Path(persistence_dir) if persistence_dir else HERMES_DATA_HOME / "usage"
