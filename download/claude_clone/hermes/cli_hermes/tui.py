"""
Interactive Terminal UI (TUI) for Hermes CLI — the main user interface.
...
from hermes.cli_hermes.skin_engine import SkinEngine, RESET, BOLD, DIM, ANSI_ESCAPE
from hermes.cli_hermes.banner import Banner
from hermes.cli_hermes.callbacks import CallbackManager, StandardCallbacks
from hermes.cli_hermes.commands import CommandRegistry, generate_help_text
...
class OutputFormatter:
    ...
    def assistant_message(self, text: str) -> str:
        ...
        if self.markdown_enabled and self._is_markdown(text):
            ...
            return f"\n{rgb_color(r, g, b)}\033[1m  Hermes:\033[0m\n{rendered}\n"
        else:
            return f"\n  \033[1m\033[32mHermes:\033[0m {text}\n"
...
class HermesTUI:
    """
    Interactive Terminal UI for Hermes CLI.
    ...
    def __init__(
        ...
        self._history_path = Path.home() / ".claude_clone" / "hermes" / "history"
    ...
    def _handle_slash_command(self, command: str):
        ...
        if cmd in ("/version", "/v"):
            print(f"  Hermes CLI v{__version__}")
            return
    ...
    def _cmd_prompt(self, arg: str):
        ...
        from hermes.cli_hermes.skin_engine import PROMPT_STYLES
    ...
    def _cmd_hub(self, arg: str):
        """Handle /hub command."""
        from hermes.cli_hermes.skills_hub import SkillsHub
