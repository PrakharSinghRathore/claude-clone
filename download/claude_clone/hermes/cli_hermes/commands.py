"""
CLI slash command implementations for Hermes TUI.
...
from hermes.cli_hermes.skin_engine import SkinEngine, RESET
...
class CommandRegistry:
    ...
    def _register_builtin_commands(self):
        ...
        self.register(CommandInfo(
            ...
            usage="/prompt [style]",
            category="appearance",
            examples=["/prompt hermes", "/prompt minimal", "/prompt starship"],
        ))
