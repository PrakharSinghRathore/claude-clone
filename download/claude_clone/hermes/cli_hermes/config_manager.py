"""
Configuration management for Hermes CLI.
...
DEFAULT_HERMES_DIR = DEFAULT_CONFIG_DIR / "hermes"
PROFILES_DIR = DEFAULT_HERMES_DIR / "profiles"
THEMES_DIR = DEFAULT_HERMES_DIR / "themes"
SESSIONS_DIR = DEFAULT_HERMES_DIR / "sessions"
CRON_DIR = DEFAULT_HERMES_DIR / "cron"
SKILLS_DIR = DEFAULT_HERMES_DIR / "skills"


class ConfigManager:
    """Manages all Hermes CLI configuration with YAML/JSON support."""
    ...
    def __init__(self, config_dir: Optional[Path] = None):
        self.config_dir = config_dir or DEFAULT_HERMES_DIR
    ...
    def load(self, profile: Optional[str] = None) -> Dict[str, Any]:
        ...
        self._config = deepcopy(self.HERMES_DEFAULTS)
