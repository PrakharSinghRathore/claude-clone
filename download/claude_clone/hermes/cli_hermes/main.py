...
Also serves as the primary entry point: `python -m hermes.cli_hermes`
"""
...
from hermes.cli_hermes.__init__ import __version__
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="hermes",
        description="Hermes CLI — Interactive terminal interface for Claude Clone",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  hermes chat                  Start interactive chat
  hermes chat --theme nord     Start chat with Nord theme
  hermes model list            List available models
  hermes model test claude-sonnet-4  Test model connectivity
  hermes doctor                Run diagnostics
  hermes setup                 Run first-time setup
  hermes config list           List configuration
  hermes gateway start         Start the gateway

Run 'hermes <command> --help' for more information on a command.
        """,
    )
...
class HermesCLI:
    ...
    def _cmd_gateway(self, args):
        ...
        from hermes.cli_hermes.gateway_cmd import GatewayManager
    ...
    def _cmd_model(self, args):
        ...
        from hermes.cli_hermes.models_cmd import ModelManager
        ...
        if cmd == "list" or not cmd:
            ...
            if action == "set" and len(model_args) > 1:
                ...
                print("  Usage: hermes model [list|set|test|pin|unpin|compare] [args]")
        else:
            print(mgr.format_model_table())

    def _cmd_tools(self, args):
        """Handle tools subcommand."""
        from hermes.cli_hermes.tools_config import ToolConfigManager
    ...
    def _cmd_skills(self, args):
        ...
        from hermes.cli_hermes.skills_config import SkillConfigManager
    ...
    def _cmd_cron(self, args):
        ...
        from hermes.cli_hermes.cron_cmd import CronManager
    ...
    def _cmd_doctor(self, args):
        ...
        from hermes.cli_hermes.doctor import Doctor
    ...
    def _cmd_config(self, args):
        ...
        if cmd == "list" or (not cmd and not config_args):
            ...
            output = getattr(args, "output", None) or "hermes_config_export.yaml"
            ...
            print("  Usage: hermes config [list|show|edit|reset|export|get|set]")

    def _cmd_mcp(self, args):
        """Handle mcp subcommand."""
        from hermes.cli_hermes.mcp_config import MCPConfigManager
    ...
    def _cmd_profile(self, args):
        ...
        if cmd == "list" or (not cmd and not profile_args):
            ...
            print("  Usage: hermes profile [list|current|switch|create|delete|export]")

    def _cmd_setup(self, args):
        """Handle setup subcommand."""
        from hermes.cli_hermes.setup import SetupWizard
